[![npm](https://img.shields.io/npm/v/whatsapp-web.js.svg)](https://www.npmjs.com/package/whatsapp-web-cogtec)
...
**NOTE** This package was modified from pedrolopez original Whatsapp-web.js for compatibility for the use in the WhatsApp Bots in the Cogtec.
...
The module is now available on npm! `npm i whatsapp-web-cogtec`
